...
List<DartBook> chaptarList = [
  ...
  DartBook(
      title: 'আপনি ফ্লাটার বলতে কী বুতেি?',
      description:
          '''ফ্লাটার হচ্ছে গুগচ্ছের তৈররকৃৈ এক ধরচ্ছের রিচ্ছেে ককাডচ্ছেচ্ছির ওচ্ছেে- কিািসকেমওয়াকস কেটি দ্বারা মারি-প্লাটফমসঅ্যারপ্লচ্ছকশে রেল্ড করা হয়। ফ্লাটার ককাে েযাাংগুচ্ছয়জ েয়, এটি হচ্ছে একটি SDK (Software Development Kit) কেটি ডাটস করাগ্রারমাং েযাাংগুচ্ছয়জ ইউজ কচ্ছর অ্যাে রিচ্ছয়ট কচ্ছর।
        '''),
  DartBook(
      title: 'ডাটট কী? ডাটট (Dart) কী? এর প্রতয়াজিীয়ো বলুি।',
      description:
          '''ডাটস হচ্ছে একটি ক্লাচ্ছয়ন্ট-অ্প্টিমাইজড করাগ্রারমাং েযাাংগুচ্ছয়জ এোং এটি রিচ্ছয় ওচ্ছয়ে এোং কমাোইে অ্যােি এর জেয েন্ট-এন্ড ইউজার ইন্টারচ্ছফি
রিচ্ছয়ট করা হয়। রশখচ্ছৈ এোং ইউজ করচ্ছৈ িহজ, িমচ্ছয়র িাচ্ছে ইভল্ভ ও ইম্প্রুভ হওয়ার কারচ্ছে িফটওয়যার কডচ্ছভেেচ্ছমন্ট কিক্টচ্ছর ডাটস এর
রচ্ছয়াজেয়ীৈা অ্চ্ছেক।
        '''),
  DartBook(
      title: 'ফ্লাটার উইতজটস (Flutter widgets) কী?',
      description:
          '''REACT কেচ্ছক ইন্সোয়ারড একটি মডােস কেমওয়াকস ইউজ কচ্ছর ফ্লাটার উইচ্ছজটি রেল্ড করা হয়। ফ্লাটার উইচ্ছজটি হচ্ছে ফ্লাটার
অ্যারপ্লচ্ছকশে এর ইউজার ইন্টারচ্ছফি। এই ফ্লাটার উইচ্ছজটি কাস্টমাইচ্ছজেে এোং রভন্ন রভন্ন উইচ্ছজটি কম্বাইে কচ্ছর আচ্ছরাও কমচ্ছপ্লক্স
উইচ্ছজট রিচ্ছয়ট করা োয়।
          '''),
  DartBook(
      title: 'ফ্লাটাতর স্টেটতলস (Stateless) এবং স্টেটফুল (Stateful) উইতজটতসর মতযে পার্টকে কী? বুনেতয় বলুি স্টো।',
      description:
          '''কস্টটফুে উইচ্ছজট হচ্ছে একটি রমউচ্ছটেে উইচ্ছজট কারে এচ্ছক ৈার োইফটাইচ্ছম অ্চ্ছেকোর ড্র করা োয় এোং এটি ৈার ইোর ডাটাও েররেৈসে কচ্ছর
োচ্ছর। কস্টটফুে উইচ্ছজট ইউজারচ্ছক রিে ররচ্ছেশ করচ্ছৈ অ্যাোও কচ্ছর। এর রকছু উিাহরে হচ্ছো কেকেক্স (Checkbox), কররডও (Radio), স্লাইডার,
ইঙ্কওচ্ছয়ে, ফরম এোং কটক্সটরফল্ড।
একটি কস্টটচ্ছেি উইচ্ছজট ইরমউচ্ছটেে এোং এক্সটারোে ইচ্ছভন্ট েযৈীৈ রেচ্ছজচ্ছক কখচ্ছো রররেল্ড করচ্ছৈ োচ্ছর ো। এটি ৈার েুচ্ছরা োইফিাইচ্ছকচ্ছে স্টযাটিক
োচ্ছক। কেই UI এরেচ্ছমন্ট গুচ্ছো েররেৈসে হয় ো কেমে কটক্সট কেচ্ছেে অ্েো আইকে, এইিে এরেচ্ছমন্ট ররচ্ছরচ্ছজন্ট করার জেয কস্টটচ্ছেি উইচ্ছজট
েযেহার করা হয়।
          '''),
  DartBook(
      title: 'স্টেটফুল (Stateful) উইতজট লাইফসাইতকল কী? বোখ্ো করুি।',
      description:
          '''কস্টটফুে উইচ্ছজট োইফিাইচ্ছকচ্ছের রকছু কেরিরফক কমেড রচ্ছয়চ্ছছ। কিগুচ্ছো হচ্ছোোঃ
রিচ্ছয়টচ্ছস্টট (createstate): এই কমেড উইচ্ছজট রেম রিচ্ছয়ট করার িময় েযেহার করা হয় এোং এর ওভাররাইট কমেড অ্েশযই এরক্সস্ট করচ্ছৈ
হচ্ছে।
২) ইরেচ্ছস্টট (initState): রিচ্ছয়টচ্ছস্টট দ্বারা কস্টট অ্েচ্ছজক্ট রিচ্ছয়ট করার েচ্ছর এই কমেড েযেহারকর হয়। এটি কস্টট এর উইচ্ছজট ইরেরশয়াোইজ করচ্ছৈ
েযেহার করা হয়।
৩) রডডচ্ছেঞ্জরডচ্ছেচ্ছন্ডরন্সি (didchangedependencies): এই কমেচ্ছডর রচ্ছয়াজে েচ্ছর েখে উইচ্ছজট এর রডচ্ছেচ্ছন্ডরন্সি কেঞ্জ হয়।
৪) রেল্ড (build): এই কমেডচ্ছক কে করা হয় উইচ্ছজট ট্রি োোচ্ছোর জন্য় এোং িে GUI করন্ডার করা হয়। রচ্ছৈযকোর UI করন্ডার করার িময় রেল্ড কে
করচ্ছৈ হচ্ছে।
৫) রডডআেচ্ছডটউইচ্ছজট (didUpdateWidge): এই কমেড ৈখেই কে করা হয় েখরে উইচ্ছজট আেচ্ছডট কিয়া হয়। এটি আচ্ছগর উইচ্ছজটও করাভাইড
কচ্ছর এোং েৈুে উইচ্ছজচ্ছটর িাচ্ছেও ৈুেো করা করচ্ছৈ কিয়।
৬) রডএক্টিচ্ছভট (Deactivate): েখেই উইচ্ছজট ট্রি কেচ্ছক এই অ্েচ্ছজক্ট ট্রি ররমুভ করা হয় ৈখে কেমওয়াকস এই কমেড কে কচ্ছর।
৭) রডচ্ছোজ (Dispose): এচ্ছক কে করা হয় েখে অ্েচ্ছজক্ট এোং এর কস্টট ট্রি কেচ্ছক োরমাচ্ছেন্টরে ররমুভ কচ্ছর কিয়া হয়।
          '''),
  DartBook(
      title: 'নম্বর (Number)',
      description:
